...
(unless (boundp '+suturo-planning-constants-services-defined+)
  ...
  (defconstant +service-name-add-point-cloud+ "/suturo/environment/add_point_cloud" "The name of the service to add a point cloud")
  (defconstant +service-name-move-robot+ "/suturo/manipulation/move" "The name of the service to move the robot")
  (defconstant +service-name-get-base-origin+ "/suturo/environment/get_base_origin" "The name of the service to get the base origin")
  ...
  (defconstant +service-name-euroc-object-to-odom-combined+ "/suturo/environment/euroc_object_to_odom_combined" "The name of the service to convert an EurocObject the a odom combined one")
  (defconstant +service-name-classify-objects+ "/suturo/perception/Classifier" "The name of the service to classify objects")
  ...
  (defconstant +service-name-start-simulator+ "/euroc_c2_task_selector/start_simulator" "The name of the service to start the simulator")
  (defconstant +topic-name-get-yaml+ "/suturo/startup/yaml_pars0r" "The name of the topic to receive the yaml file")
  (defconstant +timeout-service+ 10 "The time to wait for a service")
  (defconstant +base-origin-topic+ "/suturo/environment/get_base_origin" "The name of the service to get the base origin"))
