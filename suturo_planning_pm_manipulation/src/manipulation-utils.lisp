...
(defun rotate-quaternion (q roll pitch yaw)
  ...
  - Return :: The rotated quaternion as a message - geometry_msgs/Quaternion
  "
...
(defun three-points-to-quaternion (origin to &optional roll)
  ...
  - Return :: The quaternion resulting from the three given points - geometry_msgs/Quaternion
  "
...
(defun make-scan-poses (point distance angle frame n)
  ...
  - Return :: A list of scan-poses for the given point - (list geometry_msgs/PoseStamped)
  "
...
(defun get-place-positions (collision-object destination distance grasp)
  ...
  - Return :: A list of possible poses to place the object - (list geometry_msgs/PoseStamped)
  "
